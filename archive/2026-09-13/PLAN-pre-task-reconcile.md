...
|---|-----------|----------------------------------|------------|--------|--------|
| 1 | The Crossing: spine + draft | Beat sheet in `data/content/02/`, then the marker-tagged chapter prose | checks/the-crossing.md P1 then P2 then P2a: every beat cites a TC id or is marked imagined and both standing disagreements land as scenes; then preflight items 1 to 3 pass on the draft; then the P2a reading test passes on the first three beats (preflight items 1 to 3 on those beats, the page reads on a real phone, treatment recommendation filed). Prose-routing decision resolved at P2. | in progress | |
