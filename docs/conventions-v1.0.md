...
Version 1.0, approved 2026-08-09. Supersedes v0.2 (retained as `conventions-v0.2.md`, archive-renamed per section 11). Changes from v0.2: one amendment to section 4 (rendered terrain grids), approved 2026-08-09. This document is canonical: every chapter, vignette, map, and battle stepper is checked against it before shipping. Changes route through the decision log, never by silent edit.
