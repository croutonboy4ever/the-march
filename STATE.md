# The March: State
Updated: 2026-08-26 by Claude Code   Last known-good: 3d921b5
...
- Canonical docs: `docs/conventions-v1.0.md` (accuracy and design), `docs/build-plan-v1.0.md` (build method), `docs/roads-period-filter-memo.md`.
...
- Fact base: `~/Claude/research/carthaginian-conflicts/` (local, git-tracked, Drive-mirrored). Credentials: none needed (local files).
...
- Fact-base pointer drift: the Notion hub Links still name the NotebookLM notebook; the repo now points at the local library. Forward-only note; the canonical hub is not edited without Tony's explicit instruction.
